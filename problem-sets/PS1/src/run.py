...
parser.add_argument('p_num', nargs='?', type=int, default=1,
                    help='Problem number to run, 0 for all problems.')
args = parser.parse_args()

# Problem 1
if args.p_num == 0 or args.p_num == 1:
    p01b(train_path='/root/autodl-tmp/cs229-2018-autumn/problem-sets/PS1/data/ds1_train.csv',
         eval_path='/root/autodl-tmp/cs229-2018-autumn/problem-sets/PS1/data/ds1_valid.csv',
         pred_path='output/p01b_pred_1.txt')

    p01b(train_path='/root/autodl-tmp/cs229-2018-autumn/problem-sets/PS1/data/ds2_train.csv',
         eval_path='/root/autodl-tmp/cs229-2018-autumn/problem-sets/PS1/data/ds2_valid.csv',
